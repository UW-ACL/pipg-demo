    ...
    switch alg_type{1}
        case 'VEC'
            ...
            switch alg_type{2}
                ...
                case 'new'
                    func_name = "solvers/expipg/expipg_vec_v3" + name_suffix;
                    codegen("solvers/expipg/expipg_vec_v3.m","-config",mxcfg,"-d","solvers/expipg/codegen/mex/expipg_vec_v3/","-o",func_name,"-args",vec_args);    
                otherwise
        ...
        case 'DVEC'
            ...
            switch alg_type{2}
                ...
                case 'new'
                    func_name = "solvers/expipg/expipg_dvec_v3" + name_suffix;
                    codegen("solvers/expipg/expipg_dvec_v3.m","-config",mxcfg,"-d","solvers/expipg/codegen/mex/expipg_dvec_v3/","-o",func_name,"-args",dvec_args);    
                otherwise
                    error("Invalid detection critiera; should be 'old_infeas', 'new_infeas' or 'new'");
            end
        otherwise
