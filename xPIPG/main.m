...
xPIPG, ECOS, MOSEK, SCS, OSQP and QUADPROG
%}
...
% codegen_expipg_varsize(pp,ppv,{'VEC','new'});
% codegen_expipg_varsize(pp,ppv,{'DVEC','new'});
...
sol5 = solve_expipg(pp,ppv,{'VEC','mex','new'});
sol6 = solve_expipg(pp,ppv,{'DVEC','mex','new'});
